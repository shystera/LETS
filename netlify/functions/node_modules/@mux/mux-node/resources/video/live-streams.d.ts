...
export declare class LiveStreams extends APIResource {
     ...
     * ```
     */
    deleteNewAssetSettingsStaticRenditions(liveStreamId: string, options?: Core.RequestOptions): Core.APIPromise<void>;
    /**
     ...
     * ```
     */
    updateNewAssetSettingsStaticRenditions(liveStreamId: string, body: LiveStreamUpdateNewAssetSettingsStaticRenditionsParams, options?: Core.RequestOptions): Core.APIPromise<LiveStream>;
}
...
export declare namespace LiveStreamUpdateNewAssetSettingsStaticRenditionsParams {
